...
{
    // List 41
    public const CODE_WINNER = '01';
    public const CODE_RUNNER_UP = '02';
    public const CODE_COMMENDED = '03';
    public const CODE_SHORTLISTED = '04';
    public const CODE_LONGLISTED = '05';
    public const CODE_JOIN_WINNER = '06';
    public const CODE_NOMINATED = '07';
