...
class Extent extends Subitem
{
    ...
    // list 23
    public const TYPE_PAGE_COUNT      = "00";
    public const TYPE_NUMBER_OF_WORDS = "02";
    public const TYPE_DURATION        = "09";

    // TODO - add more unit constants
    // list 24
    public const UNIT_WORDS  = "02";
    public const UNIT_HOURS  = "04";
    public const UNIT_MINUTES   = "05";
    public const UNIT_SECONDS   = "06";
    public const UNIT_TRACKS = "11";
    public const UNIT_HHH    = "14"; // hours with leading zeros
    public const UNIT_HHHMM  = "15"; // hours and minutes
    public const UNIT_HHHMMSS   = "16"; // hours minutes seconds
